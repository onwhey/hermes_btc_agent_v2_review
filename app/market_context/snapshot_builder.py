    ...
    *,
    ...
    payload = {
        ...
        "restore_contract": {
            "4h": {
                "symbol": readiness.symbol,
                "source_table": "market_kline_4h",
                "query_source_table": "market_kline_4h",
                "query_by": ["symbol", "open_time_ms_between_start_and_end"],
                "start_open_time_ms": readiness.base_context.start_open_time_ms,
                "end_open_time_ms": readiness.base_context.end_open_time_ms,
                "actual_count": readiness.base_context.actual_count,
                "expected_count": readiness.base_context.actual_count,
                "order_by": "open_time_ms asc",
            },
            "1d": {
                "symbol": readiness.symbol,
                "source_table": "market_kline_1d",
                "query_source_table": "market_kline_1d",
                "query_by": ["symbol", "open_time_ms_between_start_and_end"],
                "start_open_time_ms": readiness.higher_context.start_open_time_ms,
                "end_open_time_ms": readiness.higher_context.end_open_time_ms,
                "actual_count": readiness.higher_context.actual_count,
