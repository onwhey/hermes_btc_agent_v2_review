"""SQLAlchemy model for the formal BTCUSDT 1d Kline table.

This file belongs to `app/storage/mysql/models`.
It defines only the `market_kline_1d` ORM mapping for stage 14-1.
It is called by Alembic metadata, the 1d Kline repository, later market-data services, and tests.
...
if mapped_column is not None:
    ...
    class MarketKline1d(Base):
        """ORM mapping for one formal BTCUSDT 1d Kline row.
        ...
        __table_args__ = (
            ...
            Index("idx_market_kline_1d_data_source", "data_source"),
            Index("idx_market_kline_1d_trigger_source", "trigger_source"),
            Index("idx_market_kline_1d_created_at_utc", "created_at_utc"),
        )
    ...
    @dataclass
    class MarketKline1d:  # type: ignore[no-redef]
