...
def build_success_result(
    ...
    *,
    ...
    return ModelAnalysisServiceResult(
        ...
        human_review_required=is_human_review_decision(review_decision),
...
def build_skipped_result_from_existing(
    ...
    *,
    ...
    return ModelAnalysisServiceResult(
        ...
        human_review_required=is_human_review_decision(str(getattr(existing_result, "review_decision", ""))),
