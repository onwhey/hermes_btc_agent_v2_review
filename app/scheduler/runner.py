...
def _strategy_pipeline_result_details(result: Any) -> dict[str, object]:
    ...
    return {
        ...
        "weak_model_run_id": getattr(result, "weak_model_run_id", None),
        "weak_model_aggregation_id": getattr(result, "weak_model_aggregation_id", None),
        "weak_model_quality_check_id": getattr(result, "weak_model_quality_check_id", None),
        "weak_model_status": getattr(result, "weak_model_status", None),
        "weak_model_quality_status": getattr(result, "weak_model_quality_status", None),
        "weak_model_directional_score": getattr(result, "weak_model_directional_score", None),
        "weak_model_risk_level": getattr(result, "weak_model_risk_level", None),
        "weak_model_trade_permission": getattr(result, "weak_model_trade_permission", None),
        "weak_model_pipeline_action": getattr(result, "weak_model_pipeline_action", None),
        "weak_model_quality_pipeline_action": getattr(result, "weak_model_quality_pipeline_action", None),
