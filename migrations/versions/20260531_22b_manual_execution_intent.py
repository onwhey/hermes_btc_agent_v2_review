...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("parsed_reason", sa.String(length=1000), nullable=True),
        sa.Column("parsed_note", sa.String(length=2000), nullable=True),
        sa.Column("parsed_payload_json", sa.String(length=4000), nullable=False),
        ...
        sa.Column("missing_fields_json", sa.String(length=1000), nullable=False),
        sa.Column("dry_run_snapshot_json", sa.String(length=4000), nullable=False),
